    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if ("email" === formRequiredItem.dataset.required) {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else if ("tel" === formRequiredItem.dataset.required) if (this.telTest(formRequiredItem)) {
                    this.addError(formRequiredItem);
                    error++;
        ...
        class SelectConstructor {
            ...
            getSelectTitleValue(selectItem, originalSelect) {
                ...
                if (originalSelect.hasAttribute("data-search")) return `<div class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue} _icon-catalog-arrow"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput}"></span></div>`; else {
                    const customClass = this.getSelectedOptionsData(originalSelect).elements.length && this.getSelectedOptionsData(originalSelect).elements[0].dataset.class ? ` ${this.getSelectedOptionsData(originalSelect).elements[0].dataset.class}` : "";
                    return `<button type="button" class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass} _icon-catalog-arrow"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`;
                }
            }
        ...
        !function(e, t) {
            ...
            var X = {
                attachEvents: function() {
                    ...
                    s.cssMode && (e.onScroll = G.bind(e)), e.onClick = D.bind(e), i.touch && !B && (t.addEventListener("touchstart", N), 
                    B = !0), H(e, "on");
                },
        ...
        for (let i = 0; i < menuBurger.length; i++) menuBurger[i].addEventListener("click", (e => {
            document.querySelectorAll(".menu")[i].classList.toggle("_active");
            if (0 != document.querySelectorAll("._opacity").length) document.querySelectorAll("._opacity")[i].classList.toggle("_active");
            document.querySelector("body").classList.toggle("_lock");
        }));
        let anchorLink = document.querySelectorAll("._anchor-link");
        function getHeaderHeight() {
            let headerHeight = 0;
            if ("fixed" == getComputedStyle(document.querySelector(".header")).position) headerHeight = document.querySelector(".header").offsetHeight;
            return headerHeight;
        }
        if (anchorLink) for (let i = 0; i < anchorLink.length; i++) anchorLink[i].addEventListener("click", (e => {
            e.preventDefault();
            document.querySelector(".menu").classList.remove("_active");
            document.querySelector("body").classList.remove("_lock");
            let id = e.target.getAttribute("href");
            if ("" != id) {
                let elem = document.querySelector(id), scrollTop = window.pageYOffset || document.documentElement.scrollTop;
                window.scrollTo({
        ...
        if (document.documentElement.clientWidth <= 992) {
            ...
            for (let i = 0; i < submenuPage.length; i++) submenuPage[i].hidden = true;
        ...
        if (!isMobile.any()) {
            ...
            document.querySelectorAll(".submenu-page__item");
            ...
            for (let i = 0; i < menuParents.length; i++) {
                ...
                menuParent.addEventListener("click", (e => {
                    ...
                    if (document.documentElement.clientWidth < 992) {
                        ...
                        _slideToggle(menuParent.querySelector(".submenu-page"));
                        menuParent.querySelector("a").classList.toggle("_active");
                    } else {
                        _slideDown(menuParent.querySelector(".submenu-page"));
        ...
        if (menuPageBurger && menuPageBody) menuPageBurger.addEventListener("click", (e => {
        ...
        for (let i = 0; i < spollerTitle.length; i++) spollerTitle[i].addEventListener("click", (e => {
            setPointerEvents(spollerTitle[i]);
            _slideToggle(spollerTitle[i].nextElementSibling);
        ...
        if (isMobile.any() && document.querySelector(".filter")) {
        ...
        if (viewCatalogList && itemsProducts) viewCatalogList.addEventListener("click", (function(e) {
        ...
        if (viewCatalogGrid && itemsProducts) viewCatalogGrid.addEventListener("click", (function(e) {
        ...
        if (sliders) {
            for (let i = 0; i < sliders.length; i++) {
                ...
                if (!slider.classList.contains("swiper-bild")) {
                    ...
                    if (slider_items) for (let i = 0; i < slider_items.length; i++) {
        ...
        if (document.querySelector(".mainslider")) {
            ...
            let mainsliderImages = Array.from(document.querySelectorAll(".mainslider__slide")).filter((item => false == item.classList.contains("swiper-slide-duplicate"))).map((item => item.querySelector(".mainslider__image")));
        ...
        if (document.querySelector(".product-slider__item")) {
            new Swiper(".product-slider__item", {
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
        ...
        if (document.querySelector(".brends-slider__body")) {
            new Swiper(".brends-slider__body", {
                observer: true,
                observeParents: true,
                slidesPerView: 5,
                spaceBetween: 0,
